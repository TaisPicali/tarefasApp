...
export  class  CpfValidator  {
    static  cpfValido  =  ( control : FormControl ) : any  =>  {
        ...
        let  rev  =  0 ;
        let  adicionar  =  0 ;
        // Verifica o tamanho digitado e alguns cpfs que passam na verificação do digito, mas são inválidos
        ...
        // Se tudo der certo e passou nas verificações returna null, ou seja, não possui erros nesse driver
        return  null ;
    }
}