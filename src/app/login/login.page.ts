...
export class LoginPage implements OnInit {
  ...
  public async login(){
    if(this.formLogin.valid){
      ...
      if(usuario){
        ...
        this.presentAllert('ADVERTÊNCIA!', 'USUÁRIO OU SENHA INVÁLIDOS!');
      }
    }
    
    else {
      this.presentAllert('ERRO!', 'Formulário errado, confira os campos!');
    }
  }
  ...
  async presentAllert(titulo: string, mensagem: string){
